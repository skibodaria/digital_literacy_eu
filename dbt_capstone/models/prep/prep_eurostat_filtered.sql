...
WHERE 
    ...
    AND indicator_code NOT LIKE ALL(ARRAY[
        ...
        'I_DSK2_CC_AB', 'I_DSK2_CC_B', 'I_DSK2_DCC_AB', 'I_DSK2_DCC_B',
        'I_DSK2_PS_AB', 'I_DSK2_PS_B', 'I_HM','I_HMA', 'I_HMD','I_HMOTH', 'I_HMPS', 'I_HMRB',
        ...
        'I_MAPS_CWSC','I_MAPS_LAP','I_MAPS_RAAD','I_MAPS_RPS','I_MAPS_RRGL','I_PCOOK1','I_USLCOOK',
        'I_DSK2_IC_S'
    ])
    AND country_code IN (
